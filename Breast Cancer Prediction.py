...
bucket = 'test12dejaviermunoz'# enter your s3 bucket where you will copy data and model artifacts
...
#bucket = 'your-s3-bucket-name' # <--- CHANGE THIS VARIABLE TO A UNIQUE NAME FOR YOUR BUCKET
